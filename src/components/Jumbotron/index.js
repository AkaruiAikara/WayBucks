        ...
        <div className="container mx-auto">
            <div className="lg:mx-20">
                <div className="relative flex flex-column lg:flex-row items-center px-8 lg:pl-20 lg:pr-80 py-20 lg:mr-48 bg-blood text-white rounded-lg">
                    ...
                    <img className="absolute z-20 w-3/4 -bottom-72 md:-bottom-3/4 right-0 left-0 mx-auto lg:bottom-auto lg:left-auto lg:-right-44 lg:w-1/2" src={jumbotronimg} alt="jumbotron" />
                </div>
            </div>
        </div>
    )
